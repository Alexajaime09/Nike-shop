...
const Hero = () => {
  ...
  className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container ">
    ...
    <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold'>
      <span className='xl:bg-white lg:whitespace-nowrap relative z-10 pr-10'>The new Arrival</span>
      <br />
    ...
    max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
      ...
      />
      <div className='flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6 lg:left-[17%]'>
        {shoes.map((shoe)=>(
          <div key={shoe}>
            <ShoeCard  
            imgURL = {shoe}
